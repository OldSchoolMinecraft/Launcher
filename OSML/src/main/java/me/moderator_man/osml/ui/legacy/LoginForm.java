            ...
            } else
            {
                ...
                accountLink.addMouseListener(new MouseAdapter()
                {
                    public void mousePressed(MouseEvent arg0)
                    {
                        try
                        {
                            Desktop.getDesktop().browse(new URL("https://www.oldschoolminecraft.com/register").toURI());
                        } catch (Exception e)
                        {
                            e.printStackTrace();
                        }
    ...
    private TransparentLabel getUpdateLink()
    {
        ...
        accountLink.addMouseListener(new MouseAdapter()
        {
            public void mousePressed(MouseEvent arg0)
            {
                try
                {
                    Desktop.getDesktop().browse(new URL("https://www.oldschoolminecraft.com").toURI());
                } catch (Exception e)
                {
                    e.printStackTrace();
                }
